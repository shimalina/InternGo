...
<div class="container">
  <font style="color:black;font-size:30px;font-weight:bolder;"><center><h1>Welcome</h1><br> <?php echo $_SESSION['companyname'] ?>!!!</center></font>   
   <?php
    $i=$row['uname'];

    ?>
  <center><?php echo "<img src='Company_logo/$i.jpg' height='10%' width='10%' />"; ?></center>
</div>
